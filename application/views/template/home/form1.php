    ...
    <div class="panel panel-default">
      ...
      <div class="col-xm-12 col-sm-6 col-md-6">
       <md-input-container class="md-block">
        ...
        <input type="text" ng-model="Encuesta.telefonoencuestado" required>
      </md-input-container>
    </div>
    <div class="col-xm-12 col-sm-6 col-md-6">
     <md-input-container class="md-block">
...
<div class="col-xm-12 col-sm-4 col-md-4">
  <md-input-container class="md-block">
    ...
    <input type="text" ng-model="Encuesta.totalhogares" required>
  </md-input-container>
</div>
<div class="col-xm-12 col-sm-4 col-md-4">
  <md-input-container class="md-block">
    <label>Número del hogar en la vivienda</label>
    <input type="text" ng-model="Encuesta.numerohogar" required>
  </md-input-container>
  </div>
<div class="col-xm-12 col-sm-12 col-md-12">
...
<div class="col-xm-12">
  <div class="row">
    <div class="col-xm-12 col-sm-4 col-md-4">
      ...
      <md-input-container class="md-block" ng-if="Encuesta.inundaciones == 1">
        ...
        <input type="text" ng-model="Encuesta.inundacionescuantas" required>
      </md-input-container>
    </div>
    <div class="col-xm-12 col-sm-4 col-md-4">
    ...
    <md-input-container class="md-block" ng-if="Encuesta.avalanchas == 1">
      <label>Cuantas veces?</label>
      <input type="text" ng-model="Encuesta.avalanchascuantas" required>
    </md-input-container>
  </div>
  <div class="col-xm-12 col-sm-4 col-md-4">
  ...
  <md-input-container class="md-block" ng-if="Encuesta.desbodamientos == 1">
    <label>Cuantas veces?</label>
    <input type="text" ng-model="Encuesta.desbodamientoscuantas" required>
  </md-input-container>
</div>
</div>
</div>
<div class="col-xm-12">
 <div class="row">
  ...
  <md-input-container class="md-block" ng-if="Encuesta.deslizamientos == 1">
    <label>Cuantas veces?</label>
    <input type="text" ng-model="Encuesta.deslizamientoscuantas" required>
  </md-input-container>
</div>
...
<md-input-container class="md-block" ng-if="Encuesta.vendavales == 1">
  <label>Cuantas veces?</label>
  <input type="text" ng-model="Encuesta.vendavalescuantas" required>
</md-input-container>
</div>
...
<md-input-container class="md-block" ng-if="Encuesta.otrodesastre == 1">
  <label>Cuantas veces?</label>
  <input type="text" ng-model="Encuesta.otrodesastrecuantas" required>
</md-input-container>
</div>
</div>
</div>
  ...
  <div class="panel panel-default">
    <div class="panel-body">
      ...
      <div class="col-xm-12 col-sm-4 col-md-4">
        <md-input-container class="md-block">
          <label>Estrato</label>
          <input type="text" ng-model="Encuesta.estrato" required>
        </md-input-container>
      </div>
